...
import '../adminPanels/pur_panel.dart';
import 'purpose_form_model.dart';
import 'rank_form_model.dart';

class purposeFormPanel extends StatefulWidget {
  @override
  _purposeFormPanelState createState() => _purposeFormPanelState();
}

class _purposeFormPanelState extends State<purposeFormPanel> {
  final TextEditingController _purposeController = TextEditingController();
  Future<Purpose>? _futureAlbum;
...
// =====================================End API CALL for barangay ==========================================================
  ...
  Future<Purpose> createPurpose(String name) async {
    final response = await http.post(
      Uri.parse('http://127.0.0.1:8000/api/purposes'),
                ...
                ElevatedButton(
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        _futureAlbum = createPurpose(_purposeController.text);
