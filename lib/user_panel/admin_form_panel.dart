...
class adminFormPanel extends StatefulWidget {
  @override
  _adminFormPanelState createState() => _adminFormPanelState();
}

class _adminFormPanelState extends State<adminFormPanel> {
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => AdSignaturePanel()));
                      }
                      // else {
                      //   Navigator.push(
                      //       context,
